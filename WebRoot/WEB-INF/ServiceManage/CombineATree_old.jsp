			...
			<div class="container-fluid">
			  <div class="navbar">
			  	<div class="navbar-inner">
			  		...
			  		<ul class="nav">
			  			<li class="active"><a href="CombineATree.jsp">可靠性组合</a></li>
			  			<li><a href="CombineBTree.jsp">适用性组合</a></li>
			  			<li><a href="#">其他</a></li>
			  		</ul>
			  	</div>
			  </div>
			  <div class="row-fluid">
				...
				<div class="span9">
					...
					<a onclick="addSub()"  role="button" class="btn" id="bt1" data-toggle="modal" style="display:none">加入组合服务</a>
						...
						<a onclick="smt(); form1.action='addCombineA.action';form1.submit()"  id="smt" class="btn" data-toggle="modal" style="display:none">提交</a>
					</div>
					<!-- Modal -->
