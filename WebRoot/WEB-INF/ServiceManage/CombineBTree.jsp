...
<head>
	...
	<title><s:text name="SystemName"></s:text> | <s:text name="ApplicabilityCombination"></s:text></title>
...
<body >
						...
						<h3 class="page-title">
							...
							<s:text name="ApplicabilityCombination"></s:text> <small><s:text name="ApplicabilityCombination.Description"></s:text></small>
						...
						<ul class="breadcrumb">
							...
							<li><a ><s:text name="ApplicabilityCombination"></s:text></a></li>
						</ul>
			  ...
			  <div class="navbar">
			  	<div class="navbar-inner">
			  		...
			  		<ul class="nav">
						...
						<li class="active"><a onclick="form2.action='combineBService.action'; form2.submit();"><s:text name="ApplicabilityCombination"></s:text></a></li>
			  	...
			  	<div class="span3">	
					...
					<script>
						function addVar()
						{
							...
							cc.innerHTML='<s:text name="ServiceComposition.ControlValue"></s:text><input name="cvar" type="text" value="">';
						}
						function deleteVar()
						{
							var table=document.getElementById("varTable");
						...
						function smt()
						{
							...
							form2.action='addCombineB.action';
							form2.submit();
						}
						function addSub()
						{
							...
							cc2.innerHTML='<s:text name="ServiceComposition.Condition"></s:text><input name="ctn" type="text" value="">';
							var cc = row.insertCell(0);
				...
				<div class="span9">
					...
					<a onclick="addSub()"  role="button" class="btn" id="bt1" data-toggle="modal" style="display:none"><s:text name="ServiceComposition.JoinCompositeService"></s:text></a>
						...
						<table class="table table-condensed" style="display:none" id="varTable">
							<tr>
								<td><s:text name="ServiceComposition.ControlValue"></s:text>
