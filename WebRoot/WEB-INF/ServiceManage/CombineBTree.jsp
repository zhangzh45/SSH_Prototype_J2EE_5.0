...
<body >
						...
						<h3 class="page-title">
							...
							适用性组合 <small>将子服务组合成业务范围更广的服务</small>
			  ...
			  <div class="navbar">
			  	<div class="navbar-inner">
			  		...
			  		<ul class="nav">
			  			<li ><a onclick="form2.action='combineAService.action'; form2.submit();">可靠性组合	</a></li>
						<li class="active"><a onclick="form2.action='combineBService.action'; form2.submit();">适用性组合</a></li>
						<li><a href="#">其他</a></li>
			  		</ul>
			  	</div>
			  </div>
			  <div class="row-fluid">
				...
				<div class="span9">
					...
					<a onclick="addSub()"  role="button" class="btn" id="bt1" data-toggle="modal" style="display:none">加入组合服务</a>
						...
						<a onclick="smt(); form2.action='addCombineB.action';form2.submit()"  id="smt" class="btn" data-toggle="modal" style="display:none">提交</a>
					</div>
					<!-- Modal -->
