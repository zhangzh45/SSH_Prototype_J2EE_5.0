...
<head>
	...
	<title><s:text name="SystemName"></s:text> | <s:text name="ServiceRemoval"></s:text></title>
				...
				<div >
					...
					<div >
						...
						<h3 class="page-title">
							...
							<s:text name="ServiceRemoval"></s:text> <small><s:text name="ServiceRemoval.Description"></s:text></small>
						...
						<ul class="breadcrumb">
							...
							<li><a href="#"><s:text name="ServiceRemoval"></s:text></a></li>
					...
					<div class="span12">
						...
						<form name="form2" action="" method="post">
							<div class="portlet box blue">
								...
								<div class="portlet-title">
									<div class="caption"><i class="icon-globe"></i><s:text name="ServiceRemoval.Operation"></s:text></div>
								</div>
								<div class="portlet-body">
									...
									<button type="button" class="btn" onclick="changeValue(); form2.action='deleteService.action'; form2.submit();"><s:text name="Submit"></s:text></button>
