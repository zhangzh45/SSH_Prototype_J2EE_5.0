...
<body >
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="#"><s:text name="ServiceComposition"></s:text></a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="#"><s:text name="ServiceCompositionRelation"></s:text></a></li>
			  ...
			  <div class="navbar">
			  	<div class="navbar-inner">
			  		...
			  		<ul class="nav">
			  			<li><a onclick="form2.action='busyClass.action';form2.submit()"><s:text name="ServiceCompositionRelation.TechnicalClassification"></s:text></a></li>
			  			<li class="active"><a onclick="form2.action='workClass.action';form2.submit()"><s:text name="ServiceCompositionRelation.BusinessClassification"></s:text></a></li>
