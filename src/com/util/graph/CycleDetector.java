...
public class CycleDetector<T>
{
	...
	public Map<T, String> getMarks() {
		return marks;
	}

	public void setMarks(Map<T, String> marks) {
		this.marks = marks;
	}

	public void setVerticesInCycles(List<T> verticesInCycles) {
		this.verticesInCycles = verticesInCycles;
	}
