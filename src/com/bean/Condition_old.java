...
public class Condition_old implements java.io.Serializable {
	...
	/** default constructor */
	public Condition_old() {
	}

	/** minimal constructor */
	public Condition_old(Integer conditionId, Service serviceByServiceId,
	...
	/** full constructor */
	public Condition_old(Service serviceByServiceId,
