...
/**
 	* A data access object (DAO) providing persistence and search support for Temp entities.
...
public class TempDAO extends HibernateDaoSupport  {
    ...
    public Temp findById( java.lang.Integer id) {
        ...
        try {
            Temp instance = (Temp) getHibernateTemplate()
                    .get("com.bean.Temp", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Temp merge(Temp detachedInstance) {
        ...
        try {
            Temp result = (Temp) getHibernateTemplate()
