		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form name="form2" class="form-horizontal" action="register.action" method="post" enctype="multipart/form-data">
					...
					<div id="ServiceQuery" class="control-group" name="external">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="radio">
								<input type="radio" name="rulesRadios" id="rulesRadios1" value="option1" checked>
								<s:text name="PublicAccess"></s:text>
							</label>
							<label class="radio">
								<input type="radio" name="rulesRadios" id="rulesRadios2" value="option2">
								<s:text name="PrivateAccessInTeam"></s:text>
							</label>
						</div>
						<input id="inputAccessRule" name="accessRule" type="hidden" value="">
					</div>
...
<script>
    ...
    $("input:radio[name='optionsRadios']").change(function (){
        var isExternal = "0";
        var internal = document.getElementsByName("internal").length;
    ...
    function changevalue(){
        ...
        var accessRule = "PublicAccess";
        if(document.getElementById("rulesRadios2").checked == true){
            accessRule = "private";   //privateAccessInTeam
        }
        else{
            accessRule = "public";    //publicAccess
		}
        document.getElementById("inputAccessRule").value = accessRule;
